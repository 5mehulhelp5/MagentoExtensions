...
class Idealo_Csvexport_Model_Source_OptionCampaign
 {

		
	 public function toOptionArray()
	 { 
		 $export_option[] = array('value'=>'1.3.2', 'label'=>Mage::helper('csvexport')->__('no')); 
		 $export_option[] = array('value'=>'1.3.1', 'label'=>'94511215 (idealo)');  
